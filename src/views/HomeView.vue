<template>
  <section id="me">
    ...
    <div id="about">
      <p>I'm a skilled Software Developer with expertise in Front-end, Back-end development and App development.
      <br />Passionate about Delivering High Quality Web, Mobile and Desktop Applications that meets my client needs.</p>
    </div>
  ...
  <section id="tech-stack">
    <h2 class="title-tac">TECH STACK</h2>
    <h3>FRONTEND</h3>
    <div class="stack">
      <ul>
    ...
    <div class="project">
      ...
      <div class="right">
        ...
        <p class="desc">This is my final project for my frontend internship.
          It features the HomePage, Student Directory and Student data. It's functionality includes search results by name, course or index number
        downloadable summary, performance graphs and more.
        The JSON file is hosted on <a href="https://smart-results-viewer.onrender.com/students/" target="_blank" rel="noopener noreferrer">
        ...
        <div class="live-code">
          <button><a href="https://smart-results-viewer-nabila.netlify.app/" target="_blank" rel="noopener noreferrer">Live
              Demo</a></button>
